...
- **Windows Update**: Força a busca e instalação de patches e drivers.
- **Gerenciador de Drivers**: Lista componentes de hardware instalados com filtro inteligente.
- **Reparo de Sistema**: Corrige falhas nos repositórios de atualização.
